    ...
    <section class="work work-five  pb-130">
        ...
        <div class="container">
            ...
            <div class="row g-4">
                ...
                <div class="col-xxl-3 col-xl-4 col-lg-6 col-md-6 wow fadeInUp" data-wow-duration="1.2s"
                    data-wow-delay=".2s">
                    <div class="work-five__item">
                        <div class="work__item-icon mb-30">
                            <!-- <div class="work-five__icon">
                ...
                <!-- <div class="col-xxl-3 col-xl-4 col-lg-6 col-md-6 wow fadeInUp" data-wow-duration="1.4s"
                    ...
                    <div class="col-xxl-3 col-xl-4 col-lg-6 col-md-6 wow fadeInUp" data-wow-duration="1.6s"
                        data-wow-delay=".6s">
                        <div class="work-five__item">
                            <div class="work__item-icon mb-30">
                                <div class="work-five__icon">
            ...
            <h2 class="text-center py-5">Biofertilizers</h2>
            <div class="row g-4">
                <div class="col-xxl-3 col-xl-4 col-lg-6 col-md-6 wow fadeInDown" data-wow-duration="1.2s"
                    data-wow-delay=".2s">
                    <div class="work-five__item">
