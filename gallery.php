...
<section class="gallery_">
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-md-4 col-12  ">
                <img src="assets/images/bottles/gallery_img2.png" alt="" class="Gallery_section img-fluid">
            </div>
            <div class="col-md-4 col-12  ">
            ...
            <div class="col-md-4 col-12  ">
                <img src="assets/images/logo/g6.png" alt="" class="Gallery_section img-fluid">
            </div>
            <div class="col-md-4 col-12  ">
