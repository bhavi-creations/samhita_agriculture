<?php include 'header.php'; ?>
    ...
    <div class="container py-5">
        ...
        <ul>
            ...
            <li>
                <p><strong>Company</strong> (referred to as either &quot;the Company&quot;, &quot;We&quot;,
                    &quot;Us&quot; or &quot;Our&quot; in this Agreement) refers to samhitha_agriculture.</p>
            </li>
            <li>
            ...
            <li>
                <p><strong>Website</strong> refers to samhitha_agriculture, accessible from <a
                        href="http://localhost/samhitha_agriculture/index.php" rel="external nofollow noopener"
                        target="_blank">http://localhost/samhitha_agriculture/index.php</a></p>
            </li>
            <li>
        ...
        <ul>
            <li>By visiting this page on our website: <a href="http://localhost/samhitha_agriculture/index.php"
                    rel="external nofollow noopener" target="_blank">http://localhost/samhitha_agriculture/index.php</a>
            </li>
        </ul>
    </div>
